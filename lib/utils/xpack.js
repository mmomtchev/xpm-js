...
export class Xpack {
  ...
  async readPackageJson () {
    ...
    let includes
    if (typeof this.packageJson.xpack.include === 'string') {
      includes = [this.packageJson.xpack.include]
    } else if (Array.isArray(this.packageJson.xpack.include)) {
      includes = this.packageJson.xpack.include
    } else if (typeof this.packageJson.xpack.include === 'undefined') {
      includes = []
    } else {
  ...
  async processInclude (inc, root) {
    ...
    for (const inc of fileData.include ?? []) {
